package com.mk.virtual.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.mk.virtual.VirtualApp;
import com.mk.virtual.repository.timezone.DateTimeWrapper;
import com.mk.virtual.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM mk_date_time_wrapper where id=%d", fieldName, id);
    }
